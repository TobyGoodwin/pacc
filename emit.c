...
static void emit_expr(struct s_node *n) {
    ...
    /* XXX it would be wonderful to put this semicolon between the #line
     * directives generated by c_code, as then we would get useful error
     * messages if the user code is missing a ')' */
    c_code(n); c_strln(";");
